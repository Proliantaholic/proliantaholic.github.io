...
$UserLanguageList[0].InputMethodTips.Add("0404:{531FDEBF-9B4C-4A43-A2AA-960E8FCDC732}{4BDF9F03-C7D3-11D4-B2AB-0080C882687E}")
$UserLanguageList[0].InputMethodTips.Add("0404:{531FDEBF-9B4C-4A43-A2AA-960E8FCDC732}{6024B45F-5C54-11D4-B921-0080C882687E}")
...
if ([System.Environment]::OSVersion.Version.Build -ge 19041) {
    ...
    Write-Host
    Write-Host "Set Use previous version of..." -ForegroundColor Black -BackgroundColor Green
...
$UserLanguageList = Get-WinUserLanguageList
$UserLanguageList[0].InputMethodTips.Remove("0404:{531FDEBF-9B4C-4A43-A2AA-960E8FCDC732}{4BDF9F03-C7D3-11D4-B2AB-0080C882687E}")
$UserLanguageList[0].InputMethodTips.Remove("0404:{531FDEBF-9B4C-4A43-A2AA-960E8FCDC732}{6024B45F-5C54-11D4-B921-0080C882687E}")
Set-WinUserLanguageList -LanguageList $UserLanguageList -Force

# Add New ChangJie and New Quick IME
powershell {
    Write-Host "Add New ChangJie and New Quick IME..." -ForegroundColor Black -BackgroundColor Green
    $UserLanguageList = Get-WinUserLanguageList
    $UserLanguageList[0].InputMethodTips.Add("0404:{B115690A-EA02-48D5-A231-E3578D2FDF80}{F3BA907A-6C7E-11D4-97FA-0080C882687E}")
    $UserLanguageList[0].InputMethodTips.Add("0404:{B115690A-EA02-48D5-A231-E3578D2FDF80}{0B883BA0-C1C7-11D4-87F9-0080C882687E}")
    Set-WinUserLanguageList -LanguageList $UserLanguageList -Force
}